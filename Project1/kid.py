...
#####read original image#####
img = cv2.imread('kid blurred-noisy.tif')
...
PILimage.save("img/kid_a.png",dpi=(200,200))
PILimage = Image.fromarray(norm_abs_lap)
PILimage.save("img/kid_b.png",dpi=(200,200))
PILimage = Image.fromarray(norm_lap_sharp)
PILimage.save("img/kid_c.png",dpi=(200,200))
PILimage = Image.fromarray(norm_sobel_final)
PILimage.save("img/kid_d.png",dpi=(200,200))
PILimage = Image.fromarray(norm_box)
PILimage.save("img/kid_e.png",dpi=(200,200))
PILimage = Image.fromarray(norm_f_img)
PILimage.save("img/kid_f.png",dpi=(200,200))
PILimage = Image.fromarray(norm_a_f_add)
PILimage.save("img/kid_g.png",dpi=(200,200))
PILimage = Image.fromarray(norm_final)
PILimage.save("img/kid_h.png",dpi=(200,200))
...
for i in range(0,256):
    s1.cell(i+2,2).value = int(hist[i])
    s1.cell(i+2,3).value = int(hist2[i])
